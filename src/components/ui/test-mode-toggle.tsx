...
const TestModeToggle: React.FC<TestModeToggleProps> = ({ onToggle, className = "" }) => {
    ...
    >
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="font-semibold text-foreground">NOWPayments Test Mode</h3>
      ...
      {config.isTestMode && (
        ...
        >
          ...
          <p className="text-xs text-muted-foreground mt-1">
            All crypto payments will use testnet currencies. No real transactions will be processed.
          </p>
